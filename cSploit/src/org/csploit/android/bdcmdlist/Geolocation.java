 ...
 */
public class Geolocation extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("exlp0it > "+ target + " > Geolocation");
        mRequestUrl = "http://" + target + ":6259/geolocation?" + "callback=&mcmdf=inapp_";
        mResultView = (TextView) findViewById(R.id.geolocation);
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    mResult = GetGeolocation(mRequestUrl);
                    Log.d("heen", "geolocaiton =" + mResult);
    ...
    // a string.
    private String GetGeolocation(String myurl) throws IOException {
        InputStream is = null;
